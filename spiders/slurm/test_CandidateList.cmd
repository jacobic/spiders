...
#SBATCH -p viz
#SBATCH -t 240
#SBATCH -J TestCandidateList
#SBATCH --mail-type=ALL
#SBATCH --mail-user=$USER@mpe.mpg.de

# 512 cores for 1000 galaxy clusters to test comp images takes about 15mins

export PROJECT="PanPipes"

# Notes:
# --mem default units are MegaBytes
...
TEST="/u/${USER}/$PROJECT/src/tests/test_CandidateList.py"
PYTEST_WRAPPER="/u/${USER}/$PROJECT/src/slurm/pytest-submit.py"
chmod u+x $PYTEST_WRAPPER
...
echo "SLURM: SLURM_JOB_NUM_NODES=${SLURM_JOB_NUM_NODES}, SLURM_NTASKS_PER_NODE=${SLURM_NTASKS_PER_NODE}, SLURM_CPUS_PER_TASK=${SLURM_CPUS_PER_TASK}"
...
echo "Spark: TOTAL_EXECUTOR_CORES=${TOTAL_EXECUTOR_CORES}, DRIVER_MEMORY=${DRIVER_MEMORY}m, EXECUTOR_MEMORY=${EXECUTOR_MEMORY}m"
...
$PYTEST_WRAPPER $TEST -vv -s -k _updated
